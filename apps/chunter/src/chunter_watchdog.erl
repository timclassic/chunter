...
handle_info({_Port, {data, {eol, Data}}}, 
	...
	{stats, {[CPU, 
	    ...
	    statsderl:increment([Name, ".cpu_", CPUS, ".minf"], Minf, 1),
	    statsderl:increment([Name, ".cpu_", CPUS, ".mjf"], Mjf, 1),
	    statsderl:increment([Name, ".cpu_", CPUS, ".xcal"], Xcal, 1),

	    statsderl:increment([Name, ".cpu_", CPUS, ".intr"], Intr, 1),
	    statsderl:increment([Name, ".cpu_", CPUS, ".Ithr"], Ithr, 1),
	    statsderl:increment([Name, ".cpu_", CPUS, ".Csw"], Csw, 1),

	    statsderl:increment([Name, ".cpu_", CPUS, ".intr"], Icsw, 1),
	    statsderl:increment([Name, ".cpu_", CPUS, ".migr"], Migr, 1),
	    statsderl:increment([Name, ".cpu_", CPUS, ".smtx"], Smtx, 1),

	    statsderl:increment([Name, ".cpu_", CPUS, ".srw"], Srw, 1),
	    statsderl:increment([Name, ".cpu_", CPUS, ".syscl"], Syscl, 1),
	    statsderl:increment([Name, ".cpu_", CPUS, ".usr"], Usr, 1),
	    statsderl:increment([Name, ".cpu_", CPUS, ".sys"], Sys, 1),
